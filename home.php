...
<body>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="https://ltdemos.informatik.uni-hamburg.de/amsol/dialyhate.png" alt="First slide">
      <div class="carousel-caption d-none d-md-block">
    <h5>Daily Hate</h5>
    <p>Daily Hate </p>
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="https://ltdemos.informatik.uni-hamburg.de/amsol/dailyfake.png" alt="Second slide">
      <div class="carousel-caption d-none d-md-block">
    <h5>Daily Fake</h5>
    <p>Daily Fake </p>
    </div>
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="https://ltdemos.informatik.uni-hamburg.de/amsol/dailytweet.png" alt="Third slide">
      <div class="carousel-caption d-none d-md-block">
    <h5>Daily Tweet</h5>
    <p>Daily Tweet </p>
    </div>
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="https://ltdemos.informatik.uni-hamburg.de/amsol/dailynews.png" alt="Third slide">
      <div class="carousel-caption d-none d-md-block">
    <h5>Daily News</h5>
    <p>Daily News </p>
    </div>
